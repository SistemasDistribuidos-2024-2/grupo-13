...
const (
	primaryNodeAddress    = "continente_server_container:50057"
	regionalServerAddress = "primary_node_container:50056"
)
...
func main() {
	...
	log.Println("[CONTINENTE SERVER] Esperando 10 segundos antes de iniciar el cliente...")
	...
	<-server.QuitChan
	log.Println("[CONTINENTE SERVER] Programa finalizado.")
}
